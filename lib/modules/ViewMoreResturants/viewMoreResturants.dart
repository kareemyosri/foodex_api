...
import '../homeScreenDetails/resturantItem.dart';

class ViewMoreResturnats extends StatelessWidget {
  const ViewMoreResturnats({Key? key}) : super(key: key);
              ...
              child: Column(
                ...
                children: [
                  ...
                  GridView.builder(
                    ...
                    itemCount: cubit.resturantModel!.data!.length,
